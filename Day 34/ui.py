...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score_label.grid(row=0, column=1, sticky=EW, padx=10, pady=10)
        ...
        self.canvas.grid(row=1, column=0, columnspan=2, sticky=EW, padx=10, pady=10)
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_question():
            ...
            self.q_text = self.canvas.itemconfig(self.q_text, text="You've reached the maximum number of questions.")
